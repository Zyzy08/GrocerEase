...
namespace frmUserAuthentication {
    ...
    public partial class AppData : global::System.Data.DataSet {
        ...
        public partial class tblloginDataTable : global::System.Data.TypedTableBase<tblloginRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public tblloginRow AddtblloginRow(string Username, string Password, string Role) {
        ...
        public partial class tblloginRow : global::System.Data.DataRow {
            ...
            public string Role {
                get {
                    try {
                        return ((string)(this[this.tabletbllogin.RoleColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Role\' in table \'tbllogin\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tabletbllogin.RoleColumn] = value;
                }
            }
            ...
            public bool IsRoleNull() {
                return this.IsNull(this.tabletbllogin.RoleColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetRoleNull() {
                this[this.tabletbllogin.RoleColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace frmUserAuthentication.AppDataTableAdapters {
    ...
    public partial class tblloginTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[tbllogin] WHERE (([Id] = @Original_Id) AND ((@IsNull_Username = 1 AND [Username] IS NULL) OR ([Username] = @Original_Username)) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)) AND ((@IsNull_Role = 1 AND [Role] IS NULL) OR ([Role] = @Original_Role)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[tbllogin] ([Username], [Password], [Role]) VALUES (@Username, " +
                "@Password, @Role);\r\nSELECT Id, Username, Password, Role FROM tbllogin WHERE (Id " +
                "= SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[tbllogin] SET [Username] = @Username, [Password] = @Password, [Role] = @Role WHERE (([Id] = @Original_Id) AND ((@IsNull_Username = 1 AND [Username] IS NULL) OR ([Username] = @Original_Username)) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)) AND ((@IsNull_Role = 1 AND [Role] IS NULL) OR ([Role] = @Original_Role)));
SELECT Id, Username, Password, Role FROM tbllogin WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::frmUserAuthentication.Properties.Settings.Default.auDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Username, Password, Role FROM dbo.tbllogin";
        ...
        public virtual int Fill(AppData.tblloginDataTable dataTable) {
        ...
        public virtual AppData.tblloginDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            AppData.tblloginDataTable dataTable = new AppData.tblloginDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(AppData.tblloginDataTable dataTable) {
